...
module.exports = class extends Generator {
    ...
    this.log(
      yosay(
        'Welcome to the smashing ' +
          chalk.red('generator-things:shell-template') +
          ' generator!'
      )
    )
  ...
  writing() {
    ...
    this.fs.copy(
      ...
      this.destinationPath('assets/' + tpl.templateName + '.png'),
      tpl
    )

    const id = camelize(tpl.templateName)

    const source = this.fs.read(this.destinationPath('templates/index.js'))
